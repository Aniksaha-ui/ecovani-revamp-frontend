function Footer() {
  return (
    <footer className="overflow-hidden rounded-t-[2rem] bg-[#0f5c58] text-white">
      <div className="mx-auto w-[92%] lg:w-[85%] xl:w-[80%] max-w-[1720px] px-4 py-12">
        <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-5">
          <div className="xl:col-span-2">
            <h2 className="text-3xl font-extrabold">Ecovani</h2>
        ...
        <div className="mt-10 border-t border-white/12 pt-5 text-sm text-white/65">
          Copyright 2026 Ecovani. All rights reserved.
        </div>
      </div>
    </footer>
  )
